...
-- Thêm người dùng mới
INSERT INTO users (
    username, full_name, gender, email, password, birthdate, hometown
) VALUES (
    'nguyennew', 'Nguyễn Thị Lan Anh', 'Nữ', 'lananh.nguyen@gmail.com', '123456', '2000-05-15', 'Hà Nội'
);

-- Kiểm tra lại view → người mới PHẢI xuất hiện
SELECT * FROM view_users_firstname
...
DELETE FROM users 
WHERE username = 'nguyennew';

-- Kiểm tra lại view → người vừa xóa PHẢI biến mất
SELECT * FROM view_users_firstname
ORDER BY created_at DESC;
